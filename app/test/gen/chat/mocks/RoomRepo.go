...
func (_m *RoomRepo) FindByID(ctx context.Context, id string) (model.Room, error) {
...
func (_m *RoomRepo) List(ctx context.Context, page int) ([]model.Room, error) {
	...
	var r0 []model.Room
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, int) ([]model.Room, error)); ok {
		return rf(ctx, page)
	}
	if rf, ok := ret.Get(0).(func(context.Context, int) []model.Room); ok {
		r0 = rf(ctx, page)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]model.Room)
